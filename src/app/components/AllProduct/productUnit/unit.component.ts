...
@Component({
    ...
    styleUrls:["./unit.component.scss","../search-product/search-product.component.scss"]
})
export class UnitComponent {
  ...
  public getBrands(){
    ...
    this.allProductService.changeDataId$
      .subscribe(resp=>{
        this.ProductsListService.getProductUnit(resp)
  ...
  private _sortProductViaType() {
    this.allProductService.getSortedType()
      .subscribe(resp => {
        ...
        this.ProductsListService.getProductUnit(unit)
        .subscribe((resp:any)=>{
